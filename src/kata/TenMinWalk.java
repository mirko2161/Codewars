...
/**
 * See https://www.codewars.com/kata/take-a-ten-minute-walk
 *
 ...
 * press the button it sends you an array of one-letter strings representing directions to walk (eg.
 * ['n', 's', 'w', 'e']). You know it takes you one minute to traverse one city block, so create a
...
public class TenMinWalk {
    ...
    public static boolean isValid(char[] walk) {
        ...
        int startPosition = 0, endPositon = 0;
        for (char c : walk) {
            if (c == 'n' || c == 'w') {
                endPositon++;
            } else if (c == 's' || c == 'e') {
        ...
        return startPosition == endPositon;
    }
