...
/**
 * See https://www.codewars.com/kata/delete-occurrences-of-an-element-if-it-occurs-more-than-n-times
 *
 * Enough is enough!
 *
 * Alice and Bob were on a holiday. Both of them took many pictures of the places they've been, and
 * now they want to show Charlie their entire collection. However, Charlie doesn't like this
 * sessions, since the motive usually repeats. He isn't fond of seeing the Eiffel tower 40 times. He
 ...
 * and then take 3, which leads to [1,2,3,1,2,3]. Example
 *
